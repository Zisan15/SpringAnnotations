...
@Configuration//bu classta config olacak demek
@ComponentScan("com.tpe")//bu packagedaki componentları tara, default: "com.tpe"  ==> ben configurasyon ayarımı hangi package içerisinde oluşturmuşsam bu package içindeki tüm componentları tara dedik
