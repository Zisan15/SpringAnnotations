...
public class MyApplication {
    public static void main(String[] args) {
        ...
        // MessageService service=context.getBean(MailService.class);  MessageService service yapmamızın nedeni interface'i kullanmak daha iyidi implementi kullanmak yerine
        //  MessageService service=context.getBean(MessageService.class);//Spring akıllı parametre olarak interface"i yazarsak ondan obje üretmeyeceğini biliyor.
                                                                          //  implemente edilen classtan obje üreteceğini biliyor interface yazsakda MailService'den obje üretiyor
